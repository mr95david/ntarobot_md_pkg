...
: Node(name), count_(0)
{
    ...
    // TODO: Se debe agregar el parametro referente al porcentaje de relacion de la separacion de las ruedas con un robot diferencial.
    ...
    // assing variables
    // 04 de Junio de 2024: TODO: Se cambia este valor, dado que las conexiones idican que la programacion anterior estaba invertida
    value_w_r = 10.273;
    value_w_i = 10.242;
